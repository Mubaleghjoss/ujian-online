...
<section class="content">
    ...
    <iframe sandbox="allow-forms allow-scripts allow-pointer-lock allow-same-origin" id="iframe1" src="https://smaafbs.sch.id" frameborder="1" width="100%" height="400px;" ></iframe>
